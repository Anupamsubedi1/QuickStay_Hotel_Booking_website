          ...
          <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
            ...
            <div className='w-full mt-4'>
              <label htmlFor="name" className='font-medium text-gray-500'>
                Hotel Name
                <input type="text" onChange={(e) => setName(e.target.value)} value={name} id="name" name="name" placeholder='Enter hotel name' className='border border-gray-300 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light' required/>
              </label>
            ...
            <div className='w-full mt-4'>
              <label htmlFor="name" className='font-medium text-gray-500'>
                Phone
                <input id = "contact"  onChange={(e) => setContact(e.target.value)} type="text" value={contact} placeholder='Type here' className='border border-gray-300 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light' required/>
              </label>
            </div>
            {/* address */}
            <div className='w-full mt-4'>
              <label htmlFor="name" className='font-medium text-gray-500'>
                Address</label>
                <input onChange={(e) => setAddress(e.target.value)} value={address} id = "address" type="text" name="address" placeholder='Type here' className='border border-gray-300 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light' required/>
