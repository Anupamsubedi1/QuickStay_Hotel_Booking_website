    ...
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        <div>
            ...
            {roomsDummyData.map((room) => (
                ...
                <img key={room._id} onClick={()=>{navigate(`/rooms/${room._id}`); scrollTo(0,0);}}
                     src={room.images[0]} alt="hotel room" title='view room details' className='max-h-65 md:w-1/2 rounded-xl shadow-lg object-cover cursor-pointer' />
